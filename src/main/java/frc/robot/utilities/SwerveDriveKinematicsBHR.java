 ...
 */
public class SwerveDriveKinematicsBHR {
   ...
   */
  public SwerveDriveKinematicsBHR(Translation2d... wheelsMeters) {
    ...
    m_prevAngle = new Rotation2d[m_numModules];
