 ...
 */
public class SwerveDriveOdometryBHR {
   ...
   */
  public SwerveDriveOdometryBHR(
      SwerveDriveKinematicsBHR kinematics, Rotation2d gyroAngle, Pose2d initialPose) {
   ...
   * @param gyroAngle The angle reported by the gyroscope.
   */
  public SwerveDriveOdometryBHR(SwerveDriveKinematicsBHR kinematics, Rotation2d gyroAngle) {
